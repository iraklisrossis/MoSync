...
namespace System.GAC
{
	...
	public class AssemblyCache
	{
		...
		public static IAssemblyEnum CreateGACEnum(string name = null)
		{
			IAssemblyEnum ae;
			IAssemblyName an = null;
			if (name != null)
				an = AssemblyCache.CreateAssemblyName(name);

			AssemblyCache.CreateAssemblyEnum(out ae, (IntPtr)0, an, ASM_CACHE_FLAGS.ASM_CACHE_GAC, (IntPtr)0);
